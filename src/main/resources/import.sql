...
insert into bar (created_at , description , direction , images , name, owner_id, id) values ( '2023-02-10', 'Es de los bares clásicos del barrio y su comida más clásica todavía. Destaca sin duda por sus tortillitas de camarones, el adobo y las coquinas', 'C/San Jacinto, 4', 'images', 'Café Bar Altozano de Triana', '5cbdc9a6-abb7-4b8d-9766-6edc374ed096','625cd031-1a54-4d3d-a6bc-b835909fa18e');
insert into bar (created_at , description , direction , images , name, owner_id, id) values ( '2023-02-10', 'Ubicado en el antiguo faro de Triana, Maria Trifulca es una comida de lujo sobre el Guadalquivir y la opción perfecta para ocasiones especiales.', 'Puente de Triana', 'images', 'María Trifulca', '117b5abd-b3e2-4b5e-a12a-f02b76204aee', 'a7b81431-43a1-4e72-8685-3647f12b3047');
--insert into bar (created_at , description , direction , images , name, owner_id, id) values ( '2023-02-12', '');
--insert into bar (created_at , description , direction , images , name, owner_id, id) values ()
--insert into bar (created_at , description , direction , images , name, owner_id, id) values ()
--insert into bar (created_at , description , direction , images , name, owner_id, id) values ()
