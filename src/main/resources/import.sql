...
insert into user_roles (user_id, roles) values ('53395e14-60d3-46d8-804f-fafd86c72a19', 0);
...
insert into user_roles (user_id, roles) values ('c8d2cf0d-1868-4ced-892a-27bea770def6', 0);
...
insert into user_roles (user_id, roles) values ('d9554666-0096-469d-96c2-eb20e31dcb23', 0);
...
insert into user_roles (user_id, roles) values ('e70c9108-ddcf-416b-a957-01feed566a64', 0);
...
insert into user_roles (user_id, roles) values ('9d6076d7-233d-4111-bd19-1c589d2a2764', 0);



--insert into user (id, username, password, email, full_name, a  ( 683cf076-0f88-4838-8e4f-91de1a78cfae, 'MSBIaLWa', '_Wz4AhD7O3', 'yrv@email.com', 'Yolanda Riera-Vidal', true, true, true, true, '2023-01-31','2023-02-01');
--insert into user (id, username, password, email, full_name, a  ( 12b34a1e-fdbf-4aa6-8ee6-a441b2312193, 'AwaciCha', '!odLg4XLg8', 'nec@email.com', 'Néstor Escudero Calatayud', true, true, true, true, '2023-01-31','2023-02-01');
--insert into user (id, username, password, email, full_name, a  ( bbc620d2-b534-4e6f-91bf-8163a164df43, 'OUsTiLan', 'ugjsh5!XGG', 'agf@email.com', 'Antonia Galiano Frías', true, true, true, true, '2023-01-31','2023-02-01');
--insert into user (id, username, password, email, full_name, a  ( 11e2191e-2056-43e7-be3b-b9b77066739e, 'anbElEyE', 'Zgnk4@GU9r', 'pfp@email.com', 'Pedro Ferrer Peiró', true, true, true, true, '2023-01-31','2023-02-01');
--insert into user (id, username, password, email, full_name, a  ( 323cddc9-09a1-4107-8e6d-9199aa2f7baf, 'ANgTAtrO', 'yjF_o9X_pE', 'rcm@email.com', 'Roque Cruz Manzanares', true, true, true, true, '2023-01-31','2023-02-01');
--insert into user (id, username, password, email, full_name, a  ( 9f771c2e-01b0-4fe1-adb7-45aa09eb4c1e, 'GLAndALV', 'v3Ct@mk5_J', 'omh@email.com', 'Óscar Malo Hernandez', true, true, true, true, '2023-01-31','2023-02-01');
--insert into user (id, username, password, email, full_name, a  ( e31194db-3c18-47a5-bfdb-172ceebf7660, 'tOMpOloy', 'AX5@r2FGxD', 'pss@email.com', 'Pilar Serna Salazar', true, true, true, true, '2023-01-31','2023-02-01');
--


insert into bar (created_at , description , direction , images , name, owner_id, id) values ( '2023-02-05', 'Bar de toda la vida al más puro estilo sevillano. Caracterizado por sus serranitos, también destacar su alioli y su flamenquín.', 'C/Justino Matute, 6', 'cibeles.jpg', 'Bar Cibeles 2', 'c8d2cf0d-1868-4ced-892a-27bea770def6', '80adfa7a-6a63-42f3-8a1e-153039544e7b');
insert into bar (created_at , description , direction , images , name, owner_id, id) values ( '2023-02-06', 'Este clásico bar trianero lleva desde 1970 sirviendo codornices fritas y adobadas y son los pajaritos más celebrados de toda Sevilla.', 'Avenida Santa Cecilia, 2', 'ruperto.jpg', 'Bar Ruperto', 'd9554666-0096-469d-96c2-eb20e31dcb23', 'c2dde920-80df-4743-86d4-3545269edcb7');
insert into bar (created_at , description , direction , images , name, owner_id, id) values ( '2023-02-10', 'Es de los bares clásicos del barrio y su comida más clásica todavía. Destaca sin duda por sus tortillitas de camarones, el adobo y las coquinas', 'C/San Jacinto, 4', 'bar-altozano.jpg', 'Café Bar Altozano de Triana', '5cbdc9a6-abb7-4b8d-9766-6edc374ed096','625cd031-1a54-4d3d-a6bc-b835909fa18e');
insert into bar (created_at , description , direction , images , name, owner_id, id) values ( '2023-02-10', 'Ubicado en el antiguo faro de Triana, Maria Trifulca es una comida de lujo sobre el Guadalquivir y la opción perfecta para ocasiones especiales.', 'Puente de Triana', 'maria-trifulca.jpg', 'María Trifulca', '117b5abd-b3e2-4b5e-a12a-f02b76204aee', 'a7b81431-43a1-4e72-8685-3647f12b3047');
insert into bar (created_at , description , direction , images , name, owner_id, id) values ( '2023-02-12', 'Muy versátil, su moderna carta se adapta tanto a cenas románticas como comidas de empresa, como tener la posibilidad de tomarte una copa etc sin perder ni un ápice en modernidad o calidad en el servicio.', 'C/betis, 69', 'abades.jpg', 'Abades Traina', '062a6a92-98eb-43c8-bbc0-4089b36962a4', 'a3c714bb-8588-4591-a7d1-3fa058304c9c');
insert into bar (created_at , description , direction , images , name, owner_id, id) values ( '2023-02-13', 'Un lugar emblemático donde tomar algo, también imprescindible en el top ten de bares y restaurantes donde comer de tapas en Triana bien y barato.', 'C/San Jacinto, 16', 'patio-san-eloy.jpg', 'Patio de San Eloy', 'e70c9108-ddcf-416b-a957-01feed566a64', '912b2cb8-389f-408a-889d-95ea65250e67');
insert into bar (created_at , description , direction , images , name, owner_id, id) values ( '2023-02-18', 'De los mejores lugares trianeros con diferencia. No es baratísimo pero merece mucho la pena por algunas de las exquisiteces que puedes tomar. Además dentro de la comida clásica suelen ser innovadores.', 'C/San Jacinto, 49', 'blanca-paloma.jpg', 'Blanca Paloma', '9d6076d7-233d-4111-bd19-1c589d2a2764', '3bb95209-da68-4f55-9eed-ba0001a1ad3c');
...
--
--
-- ( a4993c76-a232-442f-ab71-dd3e0342de96, 'AgEntRen', '@E@pgK75av', 'agp@email.com', 'Adolfo García Perez', true, true, true, true, '2023-01-31','2023-02-01');
